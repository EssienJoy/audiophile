...
function Footer() {
	return (
		<footer className='text-primary-white py-8 sm:py-[5rem] bg-secondary-black'>
			<section className='flex flex-col gap-10 px-[var(--spacing-main)] max-w-[var(--container-max)] mx-auto'>
				<section className=' flex flex-col  md:flex-row gap-10 justify-between'>
					<Logo className='justify-self-center sm:justify-self-start' />
					<nav>
				...
				<section className='flex flex-col md:flex-row gap-10  justify-between '>
					<div className='md:w-1/2 md:flex md:flex-col md:gap-10'>
					...
					<div className='flex flex-col sm:flex-row md:flex-col-reverse justify-between gap-5'>
						<p className=' text-center sm:text-left md:hidden'>
							Copyright 2021. All Rights Reserved
						</p>
